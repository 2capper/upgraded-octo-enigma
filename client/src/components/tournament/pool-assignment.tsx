...
export function PoolAssignment({ teams, pools, tournamentId, divisionId, tournament, onMatchupsGenerated }: PoolAssignmentProps) {
  ...
  const generateMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        ...
        description: `Created ${data.matchups?.length || 0} matchups. Drag and drop them onto the schedule below.`,
      });
